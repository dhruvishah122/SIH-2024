                ...
                <div className="container p-4">
                    <div className="row d-flex justify-content-evenly gap-3">
                        <div className="col-lg-3 col-md-6 mb-md-0 text-center "  style={{ marginRight: '3rem'}}>
                            <img src="./logo.jpeg" className=" m-2 roundd"></img>

                            <ul className="list-unstyled mb-0 d-flex flex-column gap-3 p-1 ">
                                <li>
                                    <a href="#!" className=" text-decoration-none text-white">Toll Free Number: 1234 2345 2345</a>
                                </li>
                                <li>
                                    <a href="#!" className=" text-decoration-none text-white">Working Hrs: 10:00 am - 5:30 pm</a>
                                </li>
                        ...
                        <div className="col-lg-3 col-md-6 mb-4 mb-md-0  text-center " >
                            <ul className="list-unstyled d-flex flex-column gap-3">
                                <li>
                                    <a href="#!" className=" text-decoration-none text-white">Startups</a>
                                </li>
                                <li>
                                    <a href="#!" className=" text-decoration-none text-white">Research</a>
                                </li>
                                <li>
                                    <a href="#!" className=" text-decoration-none text-white">IPR</a>
                                </li>
                                <li>
                                    <a href="#!" className=" text-decoration-none text-white">Investment</a>
                                </li>
                            </ul>
                        </div>
